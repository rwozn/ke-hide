#include "ntapi/TOKEN.h"
#include "ntapi/EPROCESS.h"
#include "ntapi/ETHREAD.h"
#include "ntapi/LDR_DATA_TABLE_ENTRY.h"

#include "winapi/IMAGE_NT_HEADERS.h"
#include "winapi/IMAGE_DOS_HEADER.h"
#include "winapi/IMAGE_EXPORT_DIRECTORY.h"
